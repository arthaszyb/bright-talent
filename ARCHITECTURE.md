...
Demo of the Acme Corp intelligent-staff platform. The original spec blueprint (`docs/…`, cited by section number throughout module docstrings) is not part of this repository; this file and `DESIGN.md` carry everything binding — this file fixes the cross-component conventions the specs left open.
